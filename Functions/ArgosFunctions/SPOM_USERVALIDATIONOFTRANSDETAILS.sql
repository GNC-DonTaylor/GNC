...
--/****** Object:  StoredProcedure [dbo].[SPOM_USERVALIDATIONOFTRANSDETAILS]    Script Date: 6/23/2021 7:55:55 PM ******/
--SET ANSI_NULLS ON
--GO
...
--/*
  ...
  where OMTRANSACTIONDP.INVENTORYREVIEW = 'C'
    and OMTRANSACTIONDETAIL.INVENTORYREVIEW <> 'R'
    ...
    and OMTRANSACTIONHEADER.STAGE in ('N', 'A')) and @InTransLocRowID is null
		...
		--   RAISERROR('Inventory Review. Quantity is greater than Sale Max Qty.', 16,1)	
		 set  @MaxQty = 1
		   ...
		   begin 
			 update OMTRANSACTIONDETAIL set INVENTORYREVIEW = 'N' from OMTRANSACTIONDETAIL where ROWID = @InDetailRowID AND INVENTORYREVIEW <> 'R'
