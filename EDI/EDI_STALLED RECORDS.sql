...
WHERE EDITRANSMITFLAG NOT IN ('Y', 'H')	-->THESE RECORDS HAVE NOT TRANSMITTED AND THEY SHOULD HAVE...THEY ARE STALLED
...
/*----------------------------------------------------------------------------
//-- I HAVE MANUALLY SET THREE TRANSACTIONS THAT HAVE NO DETAIL				--
//-- WITHOUT DETAIL THEY CANNOT BE SENT EDI AND ABORT THE PROCESS			--
//-- SETTING THEM TO 'H' LETS ME SEPARATE THEM FROM TRULY STALLED RECORDS	--
//----------------------------------------------------------------------------
SELECT OH.TRANSACTIONNUMBER, OH.EDITRANSMITFLAG
FROM OMTRANSACTIONHEADER OH (NOLOCK) 
WHERE OH.TRANSACTIONNUMBER IN ('40-89973-29FRT','40-89973-26FRT','40-72941-201-FRT')

BEGIN TRAN

UPDATE OMTRANSACTIONHEADER
SET EDITRANSMITFLAG = 'H'
WHERE TRANSACTIONNUMBER IN ('40-89973-29FRT','40-89973-26FRT','40-72941-201-FRT')
