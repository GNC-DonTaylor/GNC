/*	SELECT EDI.* FROM GNC_EDI_TRANSLATION EDI (NOLOCK) order by idgroup
--EDI CUSTOMER SETUP REPORT
SELECT * 
FROM VW_RPT_EDI_CUSTOMER_SETUP (NOLOCK) 
--WHERE RECORDTYPE <> 'P' 
--WHERE /*STATUS = 'A' and*/ idgroup in ('90','590')
ORDER BY ISTRADINGPARTNER DESC, GROUPSORT, status, IDSORT
*/
...
SELECT 
	...
	(SELECT TOP 1 EDI.DUNN FROM GNC_EDI_TRANSLATION EDI (NOLOCK) WHERE EDI.IDGROUP = CUST.IDGROUP) AS DUNN,
