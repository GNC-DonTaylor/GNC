/* GP_LABORGROUP_ANALYSIS
--RT:3.35 @ 36,863 
--add Projects RT:3:20 @ 37,457
--ONELINEPROJ RT:8:02 @ 37,457
--RESCALED RT:3:31 @ 37,084

--GP LaborGrp Analysis-Det EXCEL
--GP LaborGrp Analysis-Sum EXCEL

SELECT 
* 
FROM VW_RPT_GP_LABORGROUP_ANALYSIS (NOLOCK)
--MACRO-------------
...
CREATE OR ALTER VIEW [dbo].[VW_RPT_GP_LABORGROUP_ANALYSIS] 
AS 
...
FROM (
	...
	FROM ( 
			SELECT 
				...
				--ISNULL(LG.LABORGROUP,'Projects') AS LABORGROUP,
