...
--									IIF(ISNULL(ICUST.USERDEFINEDCODE_8, 'N') = 'Y', CUST.REFERENCE2, NULL) AS MAJORGROUPNAME, 
									IIF(ISNULL(ICUST.USERDEFINEDCODE_8, 'N') = 'Y', GRP.DESCRIPTION_1, NULL) AS MAJORGROUPNAME, --GROUP.DESCRIPTION_1 IS A BETTER DEFINITION FOR GROUPNAME
								...
								JOIN IDCODES GRP (NOLOCK) ON GRP.CODETYPE = 'Z7' AND GRP.CODE = CUST.IDGROUP  --JOIN GROUP DEFINITION TO USE AS GROUPNAME 
