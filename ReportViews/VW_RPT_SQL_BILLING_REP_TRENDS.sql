...
--MODIFICATION: USING VW_RPT_SQL_ACTUALS_MODIFIED NOW TO IGNORE SALESREP OVERRIDES PER DJ 2/7/2025
...
FROM	( 
        ...
        FROM	( 
				...
				SELECT	C.*, 
						...
						0 AS PREVAMOUNT, 
						0 AS GOALAMOUNT 
--				FROM	VW_RPT_SQL_ACTUALS C (NOLOCK)				--USING SALESREP OVERRIDES at the Invoice level.
				FROM	VW_RPT_SQL_ACTUALS_MODIFIED C (NOLOCK)		--USING CURRENT SALESREP at the Consignee level.
				...
				SELECT	L.*, 
						...
						0 AS GOALAMOUNT 
--				FROM	VW_RPT_SQL_ACTUALS L (NOLOCK)				--USING SALESREP OVERRIDES at the Invoice level.
				FROM	VW_RPT_SQL_ACTUALS_MODIFIED L (NOLOCK)		--USING CURRENT SALESREP at the Consignee level. 
